...
public class MeetingsActivity extends DrawerActivity {
    ...
    public void new_meetingPoint(View view)
    {
        Intent intent = new Intent(this, NewMeetingPoint.class);
    ...
    protected int createFriendPage () {
        ...
        LinearLayout linearLayout_factor = findViewById(R.id.group_layout);

        List<String> friendsName = new DatabaseQueries().getMeetingList();

        TextView titre =  findViewById(R.id.pntRencontre_predefini);
        titre.setText("Point de rencontres prédéfini");
